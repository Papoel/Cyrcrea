...
class UsersFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        // Assure que la référence 'super-admin' existe
        if ($this->hasReference('super-admin')) {
        ...
        // Assure que la référence 'admin-adresse' existe
        if ($this->hasReference('admin-adresse')) {
