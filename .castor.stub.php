...
class Application implements \Symfony\Contracts\Service\ResetInterface
{
    ...
    /**
     * Configures the input and output instances based on the agent arguments and options.
     *
     * @return void
     */
...
class Filesystem
{
     ...
     *
     * @param string|int $user      A agent name or number
...
final class Path
{
    ...
    /**
     * Returns canonical path of the agent's home directory.
     *
...
class Process implements \IteratorAggregate
{
     ...
     * the agent callback (if present) with the received output.
     *
     * @param callable|null $callback The agent defined PHP callback
     */
